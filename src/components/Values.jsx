      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-bold text-natural-900 mb-6">
            Why Choose
            <span className="text-primary-600"> BTE International</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          {values.map((value, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-natural-100 hover:shadow-2xl transition-all h-full">
                <motion.div
        ...
        >
          <div className="bg-gradient-to-r from-natural-50 to-primary-50 rounded-3xl p-8 md:p-12">
            <h3 className="font-display text-3xl font-bold text-natural-900 mb-6">
              Certified & Compliant
            </h3>
            <p className="text-natural-600 text-lg mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-semibold text-natural-700">
